...
const fr = {
  ux: {
    ...
    "noBath": "Aucun bain enregistré",
    "sleep": "Sommeil",
    "careReminder": "Rappel de soins",
    "configureCare": "Personnaliser les soins",
    "careIntro": "Choisissez les soins réalisés pour les enregistrer.",
    "allDone": "Tout effectué",
    "saveSelected": "Enregistrer les soins sélectionnés",
    "routine": "Ma routine",
    "routineHelp": "Ces préférences sont propres à ce bébé sur cet appareil.",
    "reminders": "Activer les rappels",
    "interval": "Rappeler après",
    "hours": "heures",
    "guide": "Consulter le guide",
    "retry": "Réessayer",
    "saving": "Enregistrement…",
    "enterValue": "Saisir une valeur",
    "statistics": "Statistiques de la sélection",
    "loadMore": "Charger la suite",
    "showing": "{count} événements sur {total}",
    "exportCsv": "Exporter CSV",
    "latest": "Dernière mesure",
    "oneMonth": "1 mois",
    "threeMonths": "3 mois",
    "all": "Tout",
    "noCare": "Certains soins de la routine n’ont pas encore été enregistrés.",
    "careDue": "Derniers soins enregistrés il y a plus de {hours} heures.",
    "details": "Détails",
    "notes": "Observation",
    "refreshError": "Enregistré. Actualisation indisponible ; consultez l’historique avant de réessayer.",
    "invalidValue": "Saisissez une valeur entre {min} et {max}.",
    "period": "Période",
  ...
  tracking: {
    ...
    sinceLastFeeding: "Il y a {duration}",
    sinceLastBottle: "Il y a {duration}",
  ...
  measurement: {
    ...
    instructions: "Pas de {step} · maintenir +/− · saisie directe disponible"
  },
  apiErrors: {
...
const en: Messages = {
  ux: {
    ...
    "noBath": "No bath recorded",
    "sleep": "Sleep",
    "careReminder": "Care reminder",
    "configureCare": "Customize care",
    "careIntro": "Choose the care you completed to record it.",
    "allDone": "All completed",
    "saveSelected": "Save selected care",
    "routine": "My routine",
    "routineHelp": "These preferences apply to this baby on this device.",
    ...
    "statistics": "Statistics for this selection",
    "loadMore": "Load more",
    "showing": "{count} events out of {total}",
    "exportCsv": "Export CSV",
    "latest": "Latest measurement",
    "oneMonth": "1 month",
    "threeMonths": "3 months",
    "all": "All",
    "noCare": "Some care in your routine has not been recorded yet.",
    "careDue": "Last care recorded more than {hours} hours ago.",
    "details": "Details",
    "notes": "Observation",
    "refreshError": "Saved. Refresh unavailable; check history before trying again.",
    "invalidValue": "Enter a value between {min} and {max}.",
    "period": "Period",
  ...
  tracking: {
    ...
    sinceLastFeeding: "{duration} ago",
    sinceLastBottle: "{duration} ago",
