...
const fr = {
  ...
  actions: {
    ...
    pump: "Tire-lait",
    pumpDescription: "Choisissez le sein utilisé et la quantité de lait recueillie.",
...
const en: Messages = {
  ...
  actions: {
    ...
    pump: "Breast pump",
    pumpDescription: "Choose the breast used and the amount of milk expressed.",
  ...
  apiErrors: {
    ...
    invalid_pump_quantity: "Expressed milk quantity must be between 1 and 1000 ml.",
