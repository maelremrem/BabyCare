...
describe("calculateHistoryStatistics", () => {
  test("calcule les températures, les tétées et les intervalles entre selles", () => {
    const result = calculateHistoryStatistics([
      ...
      event({ id: 4, type: "breast_right", started_at: "2026-08-01T11:00:00.000Z", duration_seconds: 900 }),
      event({ id: 5, type: "breast_right", started_at: "2026-08-01T15:00:00.000Z", duration_seconds: 1200 }),
